		    ...
		    <p class="new-add">证件类型列表&gt;&gt;新增</p>
  			...
  			<form method="post" id="Form">
  				<table cellpadding="0" cellspacing="0" class="look-table">
  					...
  					<tr>
  						<td>
  							<span class="name-title">是否上传照片：</span>
  							<s:radio list="#{'0':'否','1':'是'}" name="pictureName.mast" value="0" ></s:radio>
  						</td>
  					</tr>
  					<tr style="height: 40px;line-height: 40px;">
  						<td><span class="name-title">证件说明：</span>
  							<textarea rows="4" cols="40" name="pictureName.remark"></textarea>
  						</td>
  					</tr>
  				</table>
  			</form>
  		...
  		function tijiao(){
		  	...
		  	if(confirm('确认提交？')){
				//有一个事件触发事件可以兼容ie
			  	...
			  	openlink('${basePath}/manage/pictureName/insert.action?searchTearm1=${searchTearm1 }&searchTearm2=${searchTearm2 }&pageBean.currentPage=${pageBean.currentPage}','Form',1);
