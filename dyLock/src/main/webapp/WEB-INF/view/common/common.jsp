...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="${basePath }/adminLTE/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  <link rel="stylesheet" href="${basePath }/adminLTE/plugins/pace/pace.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>日志列表</span>
          ...
          <ul class="treeview-menu">
            <li >
            <a href="#"  onclick = "ajax('${basePath }/log/logList.do')"><i class="fa fa-tripadvisor"></i>日志列表</a></li>
            <li><a href="#"><i class="fa fa-desktop"></i>Link in level 2</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
...
<script src="${basePath }/adminLTE/plugins/pace/pace.min.js"></script>
     <script type="text/javascript">
 	$(document).ajaxStart(function() { Pace.restart(); });
     function ajax(URL){
    	 if(URL.indexOf("?") > -1){
    		 var url = URL + "&A="+ new Date().getTime();
    	 }else
   		var url = URL+"?a=" + new Date().getTime();
    	 if(URL.indexOf("deleteId") > -1){
    		 if(!confirm("确定删除吗？")){
    			 return false;
    		 }
    	 }
