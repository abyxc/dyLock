...
public class OpenLock implements Serializable {
	...
	private String judge;//开锁是否成功;2表示成功；1表示不成功
	
	private String judgeContent;//开锁失败原因;如开锁失败，说明原因
	
	private String onOff;//1表示进门；2表示开门
	...
	public String toString() {
		return "OpenLock [id=" + id + ", mobile=" + mobile + ", companyId=" + companyId + ", createTime=" + createTime + ", phoneModel=" + phoneModel + ", sdkV=" + sdkV + ", systemV=" + systemV
				+ ", lockMac=" + lockMac + ", openTime=" + openTime + ", ipAddress=" + ipAddress + ", judge=" + judge + ", judgeContent=" + judgeContent + "]";
	}
